...
import RoleForm from '../../components/entities/roles/RoleForm';
import RolesTable from '../../components/entities/roles/RolesTable';
...
export default function RolesPage() {
  ...
  const menus = [
    { title: "Create User Role", icon: "fas fa-pen-nib", tab:1 },
    { title: "View Roles", icon: "fas fa-book", tab:2 },
  ]
    ...
    <>
      ...
      <div className="flex-1 bg-white relative">
        ...
        <div className="p-5 bg-gray-100">
          ...
          <WindowCard title="Role Management">
