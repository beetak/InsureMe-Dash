...
import ShopForm from '../../components/entities/shops/ShopForm';
import ShopsTable from '../../components/entities/shops/ShopsTable';
import DisplayLayout from '../../components/Layout/DisplayLayout';

export default function ShopsPage() {

  const menus = [
    { title: "Create Shop", icon: "fas fa-pen-nib", tab:1 },
    { title: "View Shops", icon: "fas fa-book", tab:2 },
  ]
    ...
    <>
      <DisplayLayout>
        ...
        <div className="bg-gray-100">
          <h2 className="text-2xl font-semibold mb-4">TelOne Shops</h2>                
          <WindowCard title="Shop Management">
