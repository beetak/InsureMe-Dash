...
import LifeInsuranceViewModal from './LifeInsuranceViewModal';

export default function LifeInsuranceTable() {
  ...
  return (
    <>
      <div className="p-5 bg-white rounded-md border border-gray-200 border-solid border-1">
        {
          isOpen&& <LifeInsuranceModal setModal={getModal} data={modalData}/>
        }
        {
          viewOpen&& <LifeInsuranceViewModal setModal={getViewModal} data={modalData}/>
        }
        {
