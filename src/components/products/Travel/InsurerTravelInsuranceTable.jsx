...
import MotorInsuranceModal from './TravelInsuranceModal';
import MotorInsuranceViewModal from './TravelInsuranceViewModal';

const insuranceCompany = localStorage.getItem('insuranceCompany')

export default function InsurerTravelInsuranceTable() {
