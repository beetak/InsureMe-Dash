...
import MotorInsuranceModal from './PropertyInsuranceModal';
import MotorInsuranceViewModal from './PropertyInsuranceViewModal';
import travel from './travel.json'

const insuranceCompany = localStorage.getItem('insuranceCompany')

export default function InsurerPropertyInsuranceTable() {
