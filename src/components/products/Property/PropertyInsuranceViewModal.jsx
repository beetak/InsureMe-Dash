            ...
            <Modal setModal={getModal}>
                <div className="block border border-gray-200 p-8 mt-3 rounded-sm">                    
                    <div className="flex flex-col items-center text-gray-600 space-y-3">
                        ...
                        <p className=''><span className='font-semibold text-xs'>Policy Type: </span>{props.data.description}</p>
                        <p className=''><span className='font-semibold text-xs'>Policy Type: </span>{props.data.rate}</p>
