...
export default function CategoryViewModal(props) {
            ...
            <Modal setModal={getModal}>
                <div className="block border border-gray-200 p-8 mt-3 rounded-sm">                    
                    <div className="flex flex-col items-center text-gray-600 space-y-3">
                        <h2 className="text-lg font-semibold text-gray-600">{props.data.categoryName}</h2>
                        <p className=''>Description: {props.data.description}</p>
                        <p className=''>Icon: <i className={props.data.iconUrl}/></p>
