...
export default function PolicyViewModal(props) {
            ...
            <Modal setModal={getModal}>
                <div className="block border border-gray-200 p-8 mt-3 rounded-sm">                    
                    <div className="flex flex-col items-center text-gray-600 space-y-3">
                        <h2 className="text-lg font-semibold text-gray-600"><span className='font-semibold text-xs'>Policy Name: </span>{props.data.policyTypeName}</h2>
                        <p className=''><span className='font-semibold text-xs'>Policy Category: </span> {props.data.categoryName}</p>
