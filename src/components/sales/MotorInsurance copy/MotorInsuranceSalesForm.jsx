    ...
    return (
        ...
        <div className="p-5 bg-white rounded-md border border-gray-200 border-solid border-1">
                    ...
                    <div>
                        ...
                        {activeStep === 1 && (
                            <div className="p-2 bg-white rounded-xs border border-gray-200 border-solid border-1">
                                <VehicleDetails onChange={handleVehicleDetailsChange} setNextButton={getNextButton}/>                           
                            </div>
                        )}
                        {/* Step 2 content */}
                        {activeStep === 2 && (
                            <div className="p-2 bg-white rounded-xs border border-gray-200 border-solid border-1">
                                <PolicyDetails onChange={handlePolicyDetailsChange}/>
                            </div>
                        )}
                    </div>
                </div>
            ...
            <div className="flex space-x-2 pt-2">
                {activeStep === 1 && (
                    <button
                        className={`border border-gray-300 rounded-sm px-4 py-2 text-gray-100 w-40 ${!next ? 'bg-blue-200' : 'bg-blue-500'}`}
